#
#  Be sure to run `pod spec lint HTSpecs.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "Hem1ngTai" => "heming_tai@163.com" }
  # Or just: spec.author    = "Hem1ngTai"
  # spec.authors            = { "Hem1ngTai" => "" }
  # spec.social_media_url   = "https://twitter.com/Hem1ngTai"
  ...
  spec.source_files  = "HTCrashReporter"
